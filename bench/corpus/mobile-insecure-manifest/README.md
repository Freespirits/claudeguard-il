# FIXTURE: mobile-insecure-manifest (intentionally insecure)
...
contains a **deliberate** insecure Android manifest (cleartext traffic, backup
and debuggable flags); the `fixed/` variant remediates it. `expected.json`
