# FIXTURE: firebase-open-rules (intentionally insecure)
...
contains **deliberate** Firestore/Realtime Database rules allowing public
read/write; the `fixed/` variant remediates them. `expected.json` records what
