...
> fuzzing)". זה מעולם לא היה נכון — הוא שולח את ארבע הבקשות שלמעלה, ואין בו בדיקת IDOR כלל. התיקון
> מובא במפורש ולא נמחק בשקט, כי כלי אבטחה שמנפח את היכולות של עצמו עושה בדיוק את מה שהפרויקט הזה
> קיים כדי להתריע נגדו. ראו [`ROADMAP.md`](ROADMAP.md) לגבי מה שבדיקה דינמית אמיתית הייתה דורשת.
