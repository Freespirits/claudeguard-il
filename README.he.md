...
כרגע יש בו שבע רשומות — שער שבדק כתובת אחת ופנה לאחרת (ERR-001), הטענות על תלויות הפיקסצ'רים
(ERR-002), דליפת מפתח בבדיקה החיה שלנו עצמה שנמצאה בביקורת חיצונית (ERR-003), הניפוח של Tier 2
(ERR-004), החצי מהתיקון ההוא שהוכרז לפני שבוצע (ERR-005), הכותרת של הבנצ'מרק (ERR-006), ותיאור
ההתראות שלנו עצמנו שציין שני עצי פיקסצ'רים בזמן ששלישי ייצר את רובן (ERR-007).
