...
> קוד התנהגות — נא לנהוג בכבוד. דיווח על הפרה: דרך [קהילת Claude](https://www.facebook.com/groups/cladue)
> או למתחזקי הפרויקט.
...
- **Using this project to attack, scan, or test systems you do not own or are
  not authorized to test** (see the tool's authorization rules in `SECURITY.md`)
...
[community group](https://www.facebook.com/groups/cladue) or by contacting the
...
ClaudeGuardIL is a community project and is not affiliated with Anthropic.
